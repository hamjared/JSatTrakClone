	...
	public void paint(Graphics g) {
		try {
			...
			if(orbit != null) {
				...
				drawScaledCenteredEllipse(this.getWidth()/2, this.getHeight()/2 - fociScaled, orbit.getSemiMajorAxis(), 
											orbit.getEccentricity(), false, null, g2);
			}
				
			GroundStation gs = (GroundStation) GUI.groundStations.getSelectedItem();
			drawScaledCenteredEllipse(this.getWidth()/2, this.getHeight()/2, EARTH_RADIUS, 0 , true, Color.BLUE, g2);
